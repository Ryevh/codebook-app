...
export const OrderSuccess = ({ data }) => {
  return (
    <section className="text-xl text-center max-w-4xl mx-auto my-10 py-5 dark:text-slate-100 border dark:border-slate-700 rounded">
      <div className="my-5">
        <p className="bi bi-check-circle text-green-600 text-7xl mb-5">
          <AiOutlineCheck className="inline text-7xl" />
        </p>
      ...
      >
        Continue Shopping <AiOutlineShoppingCart className="inline ml-2" />
      </Link>
    </section>
  );
};
