...
export const DashboardEmpty = () => {
  return (
    <section className="text-xl text-center max-w-4xl mx-auto my-10 py-5 dark:text-slate-100 border dark:border-slate-700 rounded">
      <div className="my-5">
        <p className="bi bi-cart text-green-600 text-7xl mb-5">
          <AiOutlineShoppingCart className="inline text-9xl" />
        </p>
      ...
      >
        Continue Shopping <AiOutlineShoppingCart className="inline text-2xl" />
      </a>
    </section>
  );
};
